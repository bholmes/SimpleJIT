...
{
    public class JitCompilerArm64Tests
    {
        [Fact]
        public void CompileInstructions_SimpleAddition_GeneratesArm64Code()
        {
            // Skip test on non-ARM64 platforms
        ...
        [Fact]
        public void CompileInstructions_AllOperations_GeneratesValidArm64Code()
        {
            // Skip test on non-ARM64 platforms
            if (RuntimeInformation.ProcessArchitecture != Architecture.Arm64)
            {
